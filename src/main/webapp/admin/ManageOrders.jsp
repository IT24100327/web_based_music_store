...
<!-- Modals -->
<jsp:include page="includes/modals/manage_orders_modals/edit_order_modal.jsp">
    <jsp:param name="contextPath" value="${pageContext.request.contextPath}"/>
</jsp:include>
<jsp:include page="includes/modals/manage_orders_modals/delete_order_modal.jsp">
    <jsp:param name="contextPath" value="${pageContext.request.contextPath}"/>
</jsp:include>
