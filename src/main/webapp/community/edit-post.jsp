...
<head>
    ...
    <title>Edit Post - Community Feed</title>
    ...
    <div class="form-container">
        ...
        <c:if test="${not sessionScope.USER.admin}">
            <div class="alert alert-info">
                After editing, your post will need to be reviewed by an admin again.
            </div>
        </c:if>

        <form action="${pageContext.request.contextPath}/posts/edit" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="image1">Replace Image 1 (Optional):</label>
            ...
            <div class="form-group">
                <label for="image2">Replace Image 2 (Optional):</label>
            ...
            <div class="form-group">
                <label for="image3">Replace Image 3 (Optional):</label>
                <input type="file" id="image3" name="image3" accept="image/*">
            </div>

            <div class="form-actions">
                <button type="submit" class="btn btn-primary">Update Post</button>
                <a href="${pageContext.request.contextPath}/my-posts" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
