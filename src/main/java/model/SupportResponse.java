...
public class SupportResponse {
    ...
    /** Helper method to convert LocalDateTime to java.util.Date for JSTL **/
    public Date getResponseDateUtil() {
        return responseDate != null ? Timestamp.valueOf(responseDate) : null;
    }
