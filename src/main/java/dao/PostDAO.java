...
public class PostDAO {
    ...
    public static void createPost(Post post) throws SQLException {
        String sql = "INSERT INTO posts (userId, authorName, title, description, image1Path, image2Path, image3Path, status, createdAt, updatedAt) " +
        ...
        try (Connection con = DatabaseConnection.getConnection();
            ...
            pstmt.setString(5, post.getImage1Path());
            pstmt.setString(6, post.getImage2Path());
            pstmt.setString(7, post.getImage3Path());
    ...
    public static void updatePost(Post post) throws SQLException {
        String sql = "UPDATE posts SET title = ?, description = ?, image1Path = ?, image2Path = ?, image3Path = ?, status = ?, updatedAt = CURRENT_TIMESTAMP WHERE postId = ?";
        ...
        try (Connection con = DatabaseConnection.getConnection();
            ...
            pstmt.setString(3, post.getImage1Path());
            pstmt.setString(4, post.getImage2Path());
            pstmt.setString(5, post.getImage3Path());
            pstmt.setString(6, post.getStatus());
            pstmt.setInt(7, post.getPostId());
    ...
    private static Post createPostFromResultSet(ResultSet rs) throws SQLException {
        return new Post(
                ...
                rs.getString("image1Path"),
                rs.getString("image2Path"),
                rs.getString("image3Path"),
                rs.getString("status"),
